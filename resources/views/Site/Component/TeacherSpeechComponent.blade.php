<section class="teacherSpeech TeachHead">
    <div class="container" data-aos="fade-up">
        <div class="row">
            @if($TeacherFirst)
            <div class="col-lg-6 col-md-6 mb-3 align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            ...
            @if($MemberFirst)
                <div class="col-lg-6 col-md-6 mb-3 align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <a href="{{ url('/member')."/".$MemberFirst->member_id }}">
                    <div class="member">
                        <div class="memberBox">
                            <div class="member-img">
                        ...
                        <div class="member-info-speech">
                            <p>
                                @if(session()->get('locale') == 'en')
                                    {!! $MemberFirst->member_en_speech !!}
                                @else
                                    {!! $MemberFirst->member_bn_speech !!}
                                @endif
                            </p>
                        </div>
