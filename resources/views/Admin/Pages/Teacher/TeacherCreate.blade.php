            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/teacher-entry') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control" value="{{ old('teacher_en_name') }}" name="teacher_en_name" placeholder="Name">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('teacher_bn_name') }}" name="teacher_bn_name" placeholder="Name (বাংলা)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('teacher_index') }}" name="teacher_index" placeholder="Index Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="teacher_en_description" name="teacher_en_description" placeholder="Description ...">{{ old('teacher_en_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="teacher_bn_description" name="teacher_bn_description" placeholder="Description ...">{{ old('teacher_bn_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Speech</label>
                                        <textarea class="form-control" id="teacher_en_speech" name="teacher_en_speech" placeholder="Description ...">{{ old('teacher_en_speech') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="teacher_bn_speech" name="teacher_bn_speech" placeholder="Description ...">{{ old('teacher_bn_speech') }}</textarea>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        function DesignationGetData(){
            axios.post('/DesignationGetData',{designation_type:1}).then(function (response) {
