            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/member-entry') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control" value="{{ old('member_en_name') }}" name="member_en_name" placeholder="Name">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('member_bn_name') }}" name="member_bn_name" placeholder="Name (বাংলা)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('member_index') }}" name="member_index" placeholder="Index Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="member_en_description" name="member_en_description" placeholder="Description ...">{{ old('member_en_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="member_bn_description" name="member_bn_description" placeholder="Description ...">{{ old('member_bn_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Speech</label>
                                        <textarea class="form-control" id="member_en_speech" name="member_en_speech" placeholder="Description ...">{{ old('member_en_speech') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="member_bn_speech" name="member_bn_speech" placeholder="Description ...">{{ old('member_bn_speech') }}</textarea>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        function DesignationGetData(){
            axios.post('/DesignationGetData',{designation_type:2}).then(function (response) {
